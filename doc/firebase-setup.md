...
**Note:** 
this doc is copied from another [Git Repository](https://github.com/angular/angularfire2/blob/master/docs/install-and-setup.md), but subject to small updates(will be updated later!)
